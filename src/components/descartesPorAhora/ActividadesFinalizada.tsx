...
const ActvidadesFinalizada: React.FC = () => {
    useEffect(() => {
        document.title = "Actividades finalizadaz - UNAH COPAN";
    }, []);
                                    ...
                                    <NavLink
                                        to={
                                            location.pathname.includes('dashboard-coordinador')
                                                ? "/dashboard-coordinador/act-finalizadas/cparticipantes-actividad"
                                                : location.pathname.includes('dashboard-estudiante')
                                                    ? "/dashboard-estudiante/act-finalizadas/participantes-actividad"
                                                    : "/dashboard-voae/act-finalizadas/vparticipantes-actividad"
                                        }
...
export default ActvidadesFinalizada;
