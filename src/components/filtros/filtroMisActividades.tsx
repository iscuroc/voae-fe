...
<div className=" flex flex-wrap justify-center w-full gap-4">
    ...
    <div className="w-full md:w-auto flex items-end">
        <button
            className="h-10 px-6 py-2 text-sm mt-5 md:mt-0 font-medium text-white bg-unah-blue rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 mr-2"
