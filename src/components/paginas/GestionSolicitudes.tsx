...
const GestionSolicitudes: React.FC = () => {
    ...
    const initialData = [
        ...
        { estudiante: "Juan Carlos Rodriguez Lopez", coordinador: "Odair Sauceda", carrera: "Ingenieria en sistemas", ambito: "Social", inicio: "2024-07-10 01:14:23", final: "20/06/2025 7:00pm", estado: "Pendiente" },
        { estudiante: "Naria Alejandra Garcia Perez", coordinador: "Odair Sauceda", carrera: "Ingenieria en sistemas", ambito: "Academico", inicio: "2024-07-05 01:14:23", final: "20/06/2025 7:00pm", estado: "Pendiente" },
