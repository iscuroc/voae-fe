...
function CrearActividadCoordinador() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-4xl">
        <h1 className="text-center text-2xl font-bold mb-4">Creacion Actividades Horas VOAE Coordinador Carrera</h1>
...
export default CrearActividadCoordinador;